...
veggie_prices = driver.find_elements_by_xpath("//tr/td[5]/p")
sum=0
for price in veggie_prices:
    sum = sum + int(price.text)

print("sum of veggies is", sum)

cart_price = driver.find_element_by_class_name("totAmt").text
# cart_price = int(driver.find_element_by_class_name("totAmt").text)   this will also work
print((cart_price))

assert sum == int(cart_price)
